...
@analytic_router.get("/", response_model=Statistic, description="Возращает статистику сервиса.")
async def get_statistics(analytic_service: AnalyticsService = Depends()) -> Statistic:
