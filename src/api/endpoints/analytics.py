...
async def get_analytics(
    ...
    return Analytic(
        ...
        all_users_statistic=AllUsersStatistic(
            ...
            added_external_users=await analytic_service.get_added_external_users_statistic(
                date_limit),
            users_unsubscribed=await analytic_service.get_unsubscribed_users_statistic(
                date_limit),
        )
    )
