...
def upgrade() -> None:
    ...
    if not inspector.has_table('admin_users'):
        ...
        op.add_column('admin_users', sa.Column('created_at', sa.Date(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False))
        op.add_column('admin_users', sa.Column('updated_at', sa.Date(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False))
    ...
    if not inspector.has_table('categories'):
        ...
        op.add_column('categories', sa.Column('created_at', sa.Date(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False))
        op.add_column('categories', sa.Column('updated_at', sa.Date(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False))
    ...
    if not inspector.has_table('users_categories'):
        ...
        op.execute("UPDATE users_categories SET user_id = users.id FROM users WHERE users_categories.telegram_id = users.telegram_id")
