...
Revision ID: 56b3b72f6471
Revises: fe9ed9252c2b
Create Date: 2024-01-29 10:28:36.176060
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("fund_city", sa.String(), nullable=True),
        sa.Column("fund_rating", sa.Float(), nullable=True),
        sa.Column("fund_site", sa.String(), nullable=True),
        sa.Column("yb_link", sa.String(), nullable=True),
