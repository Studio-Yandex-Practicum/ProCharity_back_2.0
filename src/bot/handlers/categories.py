...
from src.bot.keyboards import get_categories_keyboard, get_checked_categories_keyboard, get_open_tasks_and_menu_keyboard, get_subcategories_keyboard
...
async def categories_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(
        ...
        reply_markup=await get_checked_categories_keyboard(categories),
    )
