...
class Settings(BaseSettings):
    ...
    EXTERNAL_SITE_API_VERSION: str = "v1"
    ...
    def procharity_send_user_categories_api_url(self) -> str:
        ...
        return urljoin(self.PROCHARITY_URL, f"api/{self.EXTERNAL_SITE_API_VERSION}/user_categories/")
    ...
    def procharity_send_bot_status_volunteer_api_url(self) -> str:
        ...
        return urljoin(self.PROCHARITY_URL, f"api/{self.EXTERNAL_SITE_API_VERSION}/bot_status_volunteer/")

    @property
    def procharity_send_bot_status_fund_api_url(self) -> str:
        """Получить url-ссылку на страницу отправки статуса бота для фонда."""
        return urljoin(self.PROCHARITY_URL, f"api/{self.EXTERNAL_SITE_API_VERSION}/bot_status_fund/")
