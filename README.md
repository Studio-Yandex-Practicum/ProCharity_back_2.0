...
<details>
  ...
  <ol>
    ...
    <li>
      ...
      <ul>
        <li><a href="#Установка и настройка приложения">Установка приложения</a></li>
...
1. Создайте и заполните файл .env как в полном примере [переменных окружения](env.example).
...
4. Создать .env и скопировать [`env.example`](env.example) в `.env` и задать переменные окружения.
